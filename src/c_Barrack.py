...
class Barrack(Batiment):
    ...
    def creerLazerBoi(self):
        ...
        soldat = AttaquantTerre(t[ATP.NOM], t[ATP.X], t[ATP.Y], T[ATP.NEAR_RANGE], t[ATP.FAR_RANGE], t[ATP.ATK], t[ATP.HP], t[ATP.SPEED], t[ATP.DEFENSE], t[ATP.SYSTEMID], t[ATP.PLANETEID], t[ATP.PROPRIETAIRE], t[ATP.TYPE])
