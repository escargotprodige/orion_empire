...
class Modele():
    ...
    def creersystemes(self,nbias):  # IA ajout du parametre du nombre d'ias a ajouter
        ...
        for i in range(math.floor(self.nbsystemes/3)): # -------------- ajoute un nombre de pulsars dependant du nombre de systemes
            x=random.randrange(self.diametre*10)/10
            y=random.randrange(self.diametre*10)/10
    ...
    def changeetatsystem(self,nom,systeme): #! ------------------------------ AJOUTER MÉTHODE
